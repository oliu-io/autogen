...
from autogen.trace.trace_ops import ExceptionNode
...
def run_approach(method, num_iter, trace_memory=0, trace_config='OAI_CONFIG_LIST'):
    ...
    if method == 'SanityCheck':
        ...
        res = gp_minimize(gp_f,                  # the function to minimize
        ...
        opt = IntOptimizerPSO(n_particles = trace_memory,
                            dimensions = 2,
        ...
        optimizer = FunctionOptimizerV2Memory([EW_x, NS_x], memory_size=trace_memory, config_list=autogen.config_list_from_json(trace_config))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--trace_config', type=str, default='OAI_CONFIG_LIST', help='Configuration file for trace optimization.')
