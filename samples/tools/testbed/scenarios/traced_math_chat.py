...
# mathproxyagent = compatibility(MathUserProxyAgent)(
...
train_data = [
    ...
    if train_data[x]["level"] == "Level 5" and train_data[x]["type"] != "Geometry"
]
test_data = [
    {
    ...
    if test_data[x]["level"] == "Level 5" and test_data[x]["type"] != "Geometry"
]
