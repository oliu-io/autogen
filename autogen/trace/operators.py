...
@trace_op('[is] This is an is operator of x and y.', node_dict='auto')
def is_(x : Node, y : Node):
    return x.data is y.data

@trace_op('[is_not] This is an is_not operator of x and y.', node_dict='auto')
def is_not(x : Node, y : Node):
    return x.data is not y.data

@trace_op('[in] This is an in operator of x and y.', node_dict='auto')
def in_(x : Node, y : Node):
    return x.data in y.data

@trace_op('[not_in] This is a not_in operator of x and y.', node_dict='auto')
...
@trace_op('[contains] This is a contains operator of x and y.', node_dict='auto')
