...
class StringProgramSampler:
    def __init__(self, chain_length, param_num=1,
                 ...
                 two_var_mixture=[0.7, 0.2, 0.1],
                 three_var_mixture=[0.5, 0.3, 0.1, 0.1],
                 op_mixture=[0.7, 0.3],
                 max_gen_var=10,
        ...
        self.mixture_assertion_check(three_var_mixture, 4)
    ...
    def sample_vars(self, mixture_dec_space, var_mixture):
        ...
        """
        idx = np.random.choice(range(len(mixture_dec_space)), p=var_mixture)
        sample_nums = mixture_dec_space[idx]
